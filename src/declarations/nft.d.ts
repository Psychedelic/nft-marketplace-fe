...
export interface _SERVICE {
  ...
  dip721_operator_token_identifiers: ActorMethod<
    [Principal],
    ManualReply_1
  >;
  dip721_operator_token_metadata: ActorMethod<
    [Principal],
    ManualReply_2
  >;
  dip721_owner_of: ActorMethod<[bigint], Result_2>;
  dip721_owner_token_identifiers: ActorMethod<
    [Principal],
    ManualReply_1
  >;
  dip721_owner_token_metadata: ActorMethod<
    [Principal],
    ManualReply_2
  >;
  dip721_set_approval_for_all: ActorMethod<
    [Principal, boolean],
    Result
  >;
  ...
  dip721_supported_interfaces: ActorMethod<
    [],
    Array<SupportedInterface>
  >;
